...
// //Prueba
// adm_clienteSchema.methods.generateHash = function(password){
// 	return bcrypt.hashSync(password, bcrypt.genSaltSync(9));
// }

// adm_clienteSchema.methods.validPassword = function(password){
...
adm_clienteSchema.statics.insert = function(username,nombre,apellido,correo,telefono,password,passConfirm,callback){
    Adm_Cliente.findOne({correo:correo},'correo',function(err,user){
        if(err){
            ...
            var data={
                ...
                passConfirm: bcrypt.hashSync(passConfirm, saltRounds)};
